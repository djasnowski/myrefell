                ...
                {activity.metadata && (
                    <div className="mt-0.5 flex flex-wrap gap-2 text-xs text-muted-foreground">
                        {activity.metadata.xp_gained && (
                            <span className="text-primary">+{activity.metadata.xp_gained as number} XP</span>
                        )}
                        ...
                        {activity.metadata.quantity && activity.metadata.item && (
                            <span>{activity.metadata.quantity as number}x {activity.metadata.item as string}</span>
                        )}
                    </div>
                )}
            </div>
