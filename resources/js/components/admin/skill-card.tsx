...
export function SkillCard({ name, level, xp, progress }: SkillCardProps) {
    ...
    return (
        <div className={cn("rounded-lg border border-stone-800 p-3", colors.bg)}>
            <div className="flex items-center justify-between">
                <span className={cn("font-medium capitalize", colors.text)}>{displayName}</span>
