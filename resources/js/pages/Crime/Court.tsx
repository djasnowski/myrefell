...
export default function Court({
    ...
    const getCourtIcon = (level: string) => {
        switch (level) {
            case 'village': return Building2;
            case 'barony': return Castle;
    ...
    const getCourtColor = (level: string) => {
        switch (level) {
            case 'village': return 'border-green-600/50 bg-green-900/20';
            case 'barony': return 'border-blue-600/50 bg-blue-900/20';
            case 'kingdom': return 'border-purple-600/50 bg-purple-900/20';
            default: return 'border-stone-600/50 bg-stone-800/30';
        }
    };
    ...
    const getCourtTextColor = (level: string) => {
        switch (level) {
            ...
            case 'barony': return 'text-blue-400';
            case 'kingdom': return 'text-purple-400';
                ...
                <div className="mx-auto w-full max-w-4xl">
                    ...
                    <div className="mb-4 grid grid-cols-2 gap-3 md:grid-cols-5">
                        <div className="rounded-lg border border-stone-700 bg-stone-800/50 p-3 text-center">
                            <div className="font-pixel text-lg text-stone-300">{stats.total_pending}</div>
                            <div className="font-pixel text-[10px] text-stone-500">Total Pending</div>
                        </div>
                        <div className="rounded-lg border border-green-600/50 bg-green-900/20 p-3 text-center">
                            <div className="font-pixel text-lg text-green-400">{stats.village_trials}</div>
                            <div className="font-pixel text-[10px] text-stone-500">Village Court</div>
                        </div>
                        <div className="rounded-lg border border-blue-600/50 bg-blue-900/20 p-3 text-center">
                            <div className="font-pixel text-lg text-blue-400">{stats.barony_trials}</div>
                            <div className="font-pixel text-[10px] text-stone-500">Baron's Court</div>
                        </div>
                        <div className="rounded-lg border border-purple-600/50 bg-purple-900/20 p-3 text-center">
                            <div className="font-pixel text-lg text-purple-400">{stats.kingdom_trials}</div>
                    ...
                    <div className="rounded-xl border-2 border-stone-700 bg-stone-800/50 p-4">
                        ...
                        {trials.data.length === 0 ? (
                            <div className="py-12 text-center">
                                ...
                                <div className="font-pixel text-sm text-stone-500">No pending trials</div>
                                        ...
                                        >
                                            <div className="flex items-start justify-between gap-4">
                                                <div className="flex items-start gap-3">
                                                    <div className={`rounded-lg p-2 ${getCourtColor(trial.court_level)}`}>
                                                        <CourtIcon className={`h-5 w-5 ${getCourtTextColor(trial.court_level)}`} />
                                                    </div>
                                                    <div>
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className={`rounded border px-1.5 py-0.5 font-pixel text-[10px] ${
                                                                SEVERITY_COLORS[trial.crime.severity] || 'text-stone-400 bg-stone-800/50 border-stone-600'
                                                            }`}>
                                                        ...
                                                        <div className="mt-1 flex items-center gap-3 font-pixel text-[10px] text-stone-500">
                                                            <span className="flex items-center gap-1">
                                                                ...
                                                                Defendant: {trial.defendant.username}
                                                            </span>
                                                            <span className={getCourtTextColor(trial.court_level)}>
                                                                {trial.court_display}
                                                            </span>
                                                        </div>
                                                        <div className="mt-1 flex items-center gap-3 font-pixel text-[10px] text-stone-500">
                                                ...
                                                <div className="text-right">
                                                    <span className={`rounded px-2 py-0.5 font-pixel text-[10px] ${
                                                        STATUS_COLORS[trial.status] || 'text-stone-400 bg-stone-800/50'
                                                    }`}>
                        ...
                        <div className="grid gap-3 md:grid-cols-3">
                            <div className="rounded-lg border border-green-600/30 bg-green-900/10 p-3">
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <span className="font-pixel text-xs text-green-400">Village Court</span>
                                </div>
                            ...
                            <div className="rounded-lg border border-blue-600/30 bg-blue-900/10 p-3">
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <span className="font-pixel text-xs text-blue-400">Baron's Court</span>
                                </div>
                                <p className="font-pixel text-[10px] text-stone-500">
                                    Moderate offenses and appeals. Presided by the Baron or delegate.
                                </p>
                            </div>
                            <div className="rounded-lg border border-purple-600/30 bg-purple-900/10 p-3">
                                <div className="flex items-center gap-2 mb-1">
                                    <Crown className="h-4 w-4 text-purple-400" />
                                    <span className="font-pixel text-xs text-purple-400">Royal Court</span>
                                </div>
                                <p className="font-pixel text-[10px] text-stone-500">
                                    Serious crimes and final appeals. Presided by the King or Chancellor.
                                </p>
                            </div>
                        </div>
                    </div>
