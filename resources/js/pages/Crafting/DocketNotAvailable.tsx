...
export default function DocketNotAvailable() {
    const { message } = usePage<PageProps>().props;

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Crafting Docket - Not Available" />
                ...
                <div className="mx-auto max-w-md text-center">
                    <div className="rounded-xl border-2 border-stone-700 bg-stone-800/50 p-8">
                        <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full bg-stone-700/50">
                            <ClipboardList className="h-8 w-8 text-stone-500" />
                        </div>
                        <h2 className="mb-2 font-pixel text-lg text-stone-300">No Docket Available</h2>
