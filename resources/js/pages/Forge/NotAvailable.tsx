...
import { Anvil, MapPin } from "lucide-react";
...
export default function NotAvailable() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Forge - Not Available" />
                ...
                <div className="mx-auto max-w-md text-center">
                    <div className="rounded-xl border-2 border-stone-700 bg-stone-800/50 p-8">
                        <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full bg-stone-700/50">
                            <Anvil className="h-8 w-8 text-stone-500" />
                        </div>
                        ...
                        <Link
                            href="/travel"
                            className="inline-flex items-center gap-2 rounded-lg border-2 border-orange-600 bg-orange-900/30 px-6 py-2 font-pixel text-sm text-orange-300 transition hover:bg-orange-800/50"
                        >
