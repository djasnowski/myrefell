            ...
            <div className="flex h-full flex-1 flex-col p-4">
                ...
                <div className="mb-4 space-y-2 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4">
                    ...
                    <div className="grid grid-cols-2 gap-2 sm:contents">
                        ...
                        <div className="rounded-lg border border-stone-700 bg-stone-800/50 p-2 sm:hidden">
                            <div className="mb-1 flex items-center justify-between gap-1">
                                <div className="flex min-w-0 items-center gap-1 font-pixel text-[10px] text-amber-400">
                            ...
                            <div className="mt-1 font-pixel text-[9px] text-stone-400">
                                {anvil_info.smithing_xp_to_next.toLocaleString()} XP to next
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="hidden rounded-lg border border-stone-700 bg-stone-800/50 p-3 sm:block">
                        <div className="mb-1 flex items-center justify-between gap-1">
                            <div className="flex min-w-0 items-center gap-1 font-pixel text-xs text-amber-400">
                                <Anvil className="h-3 w-3 shrink-0" />
                                <span className="truncate">Smithing</span>
                            </div>
                            <span className="shrink-0 font-pixel text-xs text-stone-300">
                ...
                {anvil_info.biome_attunement && anvil_info.biome_bonus > 0 && (
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                <div className="rounded-md bg-purple-800/50 p-1.5">
                                    {anvil_info.biome_attunement.biome === "plains" && (
                                        <Wheat className="h-4 w-4 text-green-400" />
                                    )}
                                    {anvil_info.biome_attunement.biome === "tundra" && (
                                        <Mountain className="h-4 w-4 text-blue-400" />
                                    )}
                                    {anvil_info.biome_attunement.biome === "coastal" && (
                                        <Waves className="h-4 w-4 text-cyan-400" />
                                    )}
                                    {anvil_info.biome_attunement.biome === "volcano" && (
                                ...
                                <div>
                                    <div className="flex items-center gap-1">
                                        <span className="font-pixel text-xs capitalize text-purple-300">
                                            {anvil_info.biome_attunement.biome} Attunement
                                        </span>
                                        <Dialog>
                                            ...
                                            <DialogContent className="border-purple-600/50 bg-stone-900">
                                                <DialogHeader>
                                                    <DialogTitle className="font-pixel capitalize text-purple-300">
                                                        {anvil_info.biome_attunement.biome}{" "}
                                                        Attunement
                                                    </DialogTitle>
                                                    <DialogDescription className="text-stone-400">
                                                        {
                                                            anvil_info.biome_attunement
                                                                .biome_description
                                                        }
                                                    </DialogDescription>
                                                </DialogHeader>
                                    ...
                                    <div className="flex items-center gap-1">
                                        {[1, 2, 3].map((lvl) => (
                                            <div
                                                ...
                                                className={`h-1.5 w-4 rounded-full ${
                                                    lvl <=
                                                    anvil_info.biome_attunement!.attunement_level
                                                        ? "bg-purple-400"
                                                        : "bg-stone-700"
                                                }`}
                                            />
                                        ...
                                        <span className="ml-1 font-pixel text-[10px] text-stone-400">
                                            Lvl {anvil_info.biome_attunement.attunement_level}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div className="text-right">
                                <div className="font-pixel text-sm text-purple-300">
                                    +{anvil_info.biome_bonus}% XP
                                </div>
                                {anvil_info.biome_attunement.next_level && (
                                    <div className="font-pixel text-[10px] text-stone-500">
                                        +{anvil_info.biome_attunement.next_level.bonus}% in{" "}
                                        {formatTimeRemaining(
                                            anvil_info.biome_attunement.next_level.hours_remaining,
                                        )}
                                    </div>
                                )}
                            </div>
