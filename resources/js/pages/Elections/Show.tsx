...
export default function ElectionShow({ election, candidates, user_state }: Props) {
    ...
    const handleDeclareCandidacy = () => {
        setDeclaring(true);
        router.post(
            `/elections/${election.id}/candidacy`,
            { platform },
            {
                preserveScroll: true,
                onSuccess: () => {
                            ...
                            <div className="space-y-3">
                                ...
                                {election.initiated_by && (
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-pixel text-xs text-stone-300">
                                            {election.initiated_by.username}
                                        </span>
                                    </div>
                                )}
                                ...
                                <div>
                                    <div className="mb-1 flex justify-between font-pixel text-[10px]">
                                        ...
                                        <span className="text-stone-300">
                                            {election.votes_cast} / {election.quorum_required}
                                        </span>
                                    </div>
                                    <div className="h-2 overflow-hidden rounded-full bg-stone-700">
                                        <div
                                            ...
                                            style={{
                                                width: `${Math.min(100, (election.votes_cast / election.quorum_required) * 100)}%`,
                                            }}
                                        />
                                    </div>
                                </div>
                                <div className="flex items-center justify-between rounded-lg border border-stone-700 bg-stone-800/30 p-2">
                                    ...
                                    {election.quorum_met ? (
                                        ...
                                        <span className="flex items-center gap-1 font-pixel text-xs text-stone-400">
                                            ...
                                            {election.quorum_required - election.votes_cast} more
                                            needed
                                        </span>
                                    )}
                                </div>
                                                        ...
                                                        className={`flex h-8 w-8 items-center justify-center rounded-full font-pixel text-sm ${
                                                            index === 0
                                                                ...
                                                                : index === 1
                                                                  ...
                                                                  : index === 2
                                                                    ? "bg-amber-800/50 text-amber-600"
