...
<head>
    ...
    <title>Reset Your Password - Myrefell</title>
                                ...
                                <tr>
                                    <td style="padding: 48px 40px;">
                                        ...
                                        <p style="margin: 0 0 24px 0; font-size: 15px; line-height: 1.7; color: #d4d4d8;">
                                            Someone has requested a password reset for your Myrefell account. If this was you, click the button below to choose a new password and regain access to the realm.
                                        </p>

                                        <p style="margin: 0 0 32px 0; font-size: 15px; line-height: 1.7; color: #d4d4d8;">
                                            If you did not request this reset, you can safely ignore this message. Your password will remain unchanged.
                                        </p>
